 ...
 * @module helpers
 */
import type { AuthenticatedContext, PlaidAccount, PlaidItem } from "./types.js";
 ...
 * ```
 */
export declare function requireAuth(ctx: AuthenticatedContext): Promise<string>;
/**
 ...
 * ```
 */
export declare function requireOwnership(ctx: AuthenticatedContext, resourceUserId: string): Promise<void>;
/**
 ...
 */
export declare function requireItemOwnership(ctx: AuthenticatedContext, plaidItemId: string, plaidApi: Pick<PlaidComponent["public"], "getItem">): Promise<PlaidItem>;
/**
 ...
 */
export declare function requireAccountOwnership(ctx: AuthenticatedContext, accountId: string, plaidApi: Pick<PlaidComponent["public"], "getAccountsByUser">): Promise<PlaidAccount>;
