...
/**
 * Props for SubscriptionUpgraded email template
 */
    ...
    return (
        <Html>
            <Tailwind theme={theme}>
                <Head />
                <Preview>Your plan has been upgraded to {newPlanName}</Preview>
                <Body>
                        ...
                        <Section align="left" className="max-w-full px-6 py-8">
                            <Row className="mb-6">
                                <Text className="text-tertiary">
                                    ...
                                    <br />
                                    <br />
                                    Great news! Your subscription has been upgraded to <strong>{newPlanName}</strong>.
                                    {effectiveDate && (
                                        <> This change is effective {effectiveDate}.</>
                                    )}
                                </Text>
                            </Row>
                            ...
                            <Row className="mb-6">
                                <Button href={dashboardUrl}>
                                    <Text className="text-md font-semibold">View your new features</Text>
                                </Button>
                            </Row>
