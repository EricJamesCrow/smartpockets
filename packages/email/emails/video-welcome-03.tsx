...
/**
 * Props for VideoWelcome03 email template
 */
export interface VideoWelcome03Props {
    /** Theme variant */
    theme?: "light" | "dark";
    /** Recipient's name */
...
export const VideoWelcome03 = ({
    theme,
    recipientName,
    videoThumbnailUrl = "https://www.untitledui.com/images/email/video-welcome-03.webp",
    videoUrl,
    loginUrl,
    brandConfig,
}: VideoWelcome03Props) => {
                        ...
                        <Container align="left" className="max-w-full bg-primary px-6 py-8">
                            ...
                            <Row className="mb-12">
                                <Text className="text-center text-md text-tertiary md:text-lg">
                                    {greeting} for checking out {config.companyName}. Here are a few tips to
                                    help you get up and running as soon as possible. If you have any
                            ...
                            <Row className="border-collapse">
                                <Column align="center">
                                    <Button
                                        href={videoUrl}
                                        color="secondary"
                                        className="mr-1.5 text-center align-middle"
                                    >
                                        <Img
                                            aria-hidden
                                    ...
                                    <Button href={loginUrl} className="ml-1.5">
                                        Log in
                                    </Button>
                                </Column>
                            </Row>
