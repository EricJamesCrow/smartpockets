...
import type { CommandDropdownMenuItemProps } from "../command-menus/base-components/command-menu-item";
...
export const CommandMenuIntegrationsMenu = () => {
                ...
                emptyState={
                    <EmptyState size="sm" className="overflow-hidden p-6 pb-10">
                        ...
                        <EmptyState.Content className="mb-0">
                            ...
                            <EmptyState.Description>Your search did not match any integrations. Please try again.</EmptyState.Description>
                        </EmptyState.Content>
                    </EmptyState>
                }
            >
