...
export const CreditCard = ({ className, ...props }: CreditCardProps) => (
  <div
    className={cx(
      "group/kibo-credit-card perspective-distant aspect-[8560/5398] w-full text-white",
      "@container",
      className
    )}
    {...props}
...
export const CreditCardName = ({
  ...
  <p
    className={cx("font-semibold uppercase", className)}
    style={{
      lineHeight: "100%",
      ...style,
    }}
...
export const CreditCardLogo = ({
  ...
  <div
    className={cx("absolute top-0 right-0 size-1/6", className)}
    {...props}
  />
);
...
export const CreditCardNumber = ({
  ...
  <p
    className={cx("font-mono", "@xs:text-2xl", className)}
    style={{
      lineHeight: "100%",
      ...style,
    }}
